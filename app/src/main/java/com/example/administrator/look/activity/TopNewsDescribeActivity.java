...
import com.example.administrator.look.Presents.Presents.implPresents.TopNewsDesPresenterImpl;
...
public class TopNewsDescribeActivity extends BaseActivity implements ITopNewsDesFragment{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.topnews_dedcrible);
...
//                    mShot.animate().alpha(1f).setDuration(800L).start();
    ...
    public void showError(String error) {
        Snackbar.make(mDraggableFrame, "请检查网络", Snackbar.LENGTH_INDEFINITE).setAction("重试", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getData();
            }
